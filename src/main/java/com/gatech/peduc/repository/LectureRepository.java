...
public interface LectureRepository extends JpaRepository<Lecture, Long> {
    ...
    @Query("select lecture from Lecture lecture left join LectureActivity la on lecture.id = la.lecture.id where lecture.user.id = :id AND lecture.presentationDate < :z AND la.lectureStatus = 'ACTIVE'")
